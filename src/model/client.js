...
export const getCustomServerSideProps = async (context, page) => {
  const props = {}
  if (page === '/collection/[id]') {
    const collection = await getNFTsSingle(context.query.id)
    _.assign(props, collection);
  }
  // console.log(req);
  // console.log(res);
...
export const getAllNFTs = async (totalSupply) => {
...
export const getNFTsSingle = async (id) => {
