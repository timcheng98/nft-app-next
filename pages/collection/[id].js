          ...
          <Row>
            <Col xs={24} md={12}>
              <Row justify="center" gutter={[0, 30]}>
                <Col xs={24} lg={18}>
                  <Image alt="icon" src='wallstreetbet.png' className="collection" />
                </Col>
                <Col xs={24} md={0}>
                ...
                <Col span={24}>
                  ...
                  >
                    ...
                    <Row style={defaultStyles.subHeader} justify="space-between">
                      <Col>Rank</Col>
                      <Col>9087</Col>
                    </Row>
                    <Row style={defaultStyles.subHeader} justify="space-between">
            ...
            <Col xs={0} md={12}>
              ...
              <Row style={defaultStyles.subHeader} gutter={[0, 30]}>
                ...
                <Col span={24}>
                  <Button
                    style={{ background: '#1E90FF', border: 'none', width: 160 }}
                    className="app-button"
